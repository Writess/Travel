...
/**
 * 功能:随机生成中文姓名，性别，Email，手机号，住址 作者:王朋飞 2017年7月24日下午7:38:37
 */
public class RandomGeneration {
	...
	/**
	 * 功能:返回随机生日 作者:王朋飞 2017年7月25日下午2:00:34
	 */
	public static Date getDate(int start, int end) {
		long time = new Date().getTime();
		long rand = (long) ((start + Math.random() * (end - start)) * 86400 * 1000 * 365);
		long stat = time - rand;
		/*
		 * SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd"); String
		 * value = format.format( new Date(stat));
		 */
		return new Date(stat);
	}
	...
	public static String getEmail(int lMin, int lMax) {
		...
		for (int i = 0; i < length; i++) {
			...
			strb.append(base.charAt(number));
		}
		strb.append(email_suffix[(int) (Math.random() * email_suffix.length)]);
	 ...
	 * 返回手机号码
	 */
	private static String[] telFirst = "134,135,136,137,138,139,180,181,182,187,188,189,130,131,132,185,186,133,183"
			.split(",");
	...
	public  Person getAddress() {
		...
		person.setRealname(getChineseName());
		person.setSex(name_sex);
		person.setRoad(getRoad());
		person.setMobile(getTel());
